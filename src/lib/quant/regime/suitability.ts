import { VolatilityRegime, SuitabilityResult, SuitabilityRating } from "./types";
...
export function evaluateStrategySuitability(
  ...
  if (regime === "LOW_VOL_COMPLACENCY" || regime === "VOL_COMPRESSION") {
  ...
  } else if (regime === "PANIC_EXPANSION" || regime === "LIQUIDITY_SHOCK") {
  ...
  } else if (regime === "POST_EVENT_CRUSH") {
    if (specs.volBias === "short") {
  ...
  } else if (regime === "EARNINGS_INSTABILITY") {
